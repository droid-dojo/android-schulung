package ninja.droiddojo.samples.compose.state.hoisting
...
import ninja.droiddojo.samples.compose.state.hoisting.data.Post
import ninja.droiddojo.samples.compose.state.hoisting.data.User
import ninja.droiddojo.samples.compose.state.hoisting.ui.PostCard
...
private fun HomeScreen(
    uiState: HomeScreenUiState, onProfileClick: (User) -> Unit = {}
) {
    Scaffold(
        topBar = {
