...
fun HomeScreen(
    ...
    //Task: Create a ViewModel that provides the current State
    //      The state should initially be loading
    //      in the viewmodel's `init` method change the state to Content

    //Task: let the Current Composable accept a ViewModel instance.
    //Task: Consume the State from the ViewModel and call the hoisted State variant
